$('document').ready(function(){
    $('[id="check-button"]').on('click',function() {
        ...
        var back = document.getElementById("back").attributes.item(1).value;
        var nextButton = document.getElementById("next-button");

        if (inputValue.localeCompare(back) == 0) {
            ...
            document.getElementById("input").value = document.getElementById("back").attributes.item(1).value;
        }
